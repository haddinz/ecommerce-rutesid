    ...
    <Layout title="Register" description="Register Page">
      <div className="container">
        <div className="flex justify-center items-center flex-col mb-10 ">
          <h3 className="w-full text-center text-2xl md:text-4xl font-bold text-cyan-700 mb-6">
            Welcome To <br /> Register Page
          </h3>
        ...
        <div className="flex items-center flex-col">
          <form className="w-full md:w-[450px]" onSubmit={submitHandler}>
            <div className="mb-3 flex flex-col">
              <label htmlFor="name">Name</label>
              <input
                className="text-sm md:text-base px-4 py-4 mt-2 focus:outline-none bg-cyan-700 rounded-lg"
                type="name"
                autoFocus
                required
                id="name"
